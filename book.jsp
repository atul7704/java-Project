...
<title>Contact Us</title>
  ...
  body{
   ...
   background-image: url("https://t3.ftcdn.net/jpg/07/54/93/70/360_F_754937013_Tvqma7ELVFvzdXAqJqzcxI90gpwIoD4l.jpg");
...
String pepl=request.getParameter("people");
int n=Integer.parseInt(pepl);
...
try {
    ...
    // Query
    String Q = "INSERT INTO booktable(name,email,phone,date,time,people,message) VALUES (?, ?, ?, ?,?,?,?)";
    pstmt = con.prepareStatement(Q);
    pstmt.setString(1, nm);
    pstmt.setString(2, eml);
    pstmt.setString(3, phn);
    pstmt.setString(4, dat);
    pstmt.setString(5, tim);
    pstmt.setInt(6, n);
    pstmt.setString(7, mess);
    int r = pstmt.executeUpdate();

    if (r > 0) {
       out.println("<center>    <h1>Your booking request was sent. We will call back or send an Email to confirm your reservation. Thank you!</h1> <center>");
    } else {
